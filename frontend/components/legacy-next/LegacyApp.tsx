            ...
            return (
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 overflow-hidden relative">
                        ...
                        {tab === 'survey' && <SurveyTab user={user} />}
                        {tab === 'collections' && <CollectTab user={user} />}
                    </div>
                </div>
            );
        }
